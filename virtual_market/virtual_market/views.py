        ...
        return Response(
            {
                ...
                "publication_requests": base + "api/publication-requests/",
                "settings": base + "api/settings/",
                "admin_stats": base + "api/admin/stats/",
                "admin_activity": base + "api/admin/activity/",
                "admin_moderation_queue": base + "api/admin/moderation-queue/",
                "admin_meta": base + "api/admin/meta/",
